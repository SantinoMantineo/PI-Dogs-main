...
export default function Form() {
  ...
  return (
    <>
      ...
      <div className={style.containerAdd}> 
        ...
        <h2 className={style.addH2}>Felicidades, ahora puedes volver a Home <br></br>y buscar a tu perro por nombre! <br></br><br></br>Tambien puedes ver todos los perros que has creado <br></br> aplicando el filtro...</h2>
  ...
  <div className={style.container}>
    <form onSubmit={handleSubmit} className={style.create}>
      ...
      <button type="submit" className={style.button}>Crear Perro</button>
    </form>
    </div>
    }
    </>
